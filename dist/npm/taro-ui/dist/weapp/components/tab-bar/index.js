  ...
  _createClass(AtTabBar, [{
    ...
    value: function _createData() {
      ...
      var loopArray1 = tabList.map(function (item, i) {
        ...
        var _genCompid = (0, _taroWeapp.genCompid)(__prefix + 'dzzzzzzzzz' + i, true),
        ...
        var _genCompid3 = (0, _taroWeapp.genCompid)(__prefix + 'ezzzzzzzzz' + i, true),
        ...
        var _genCompid5 = (0, _taroWeapp.genCompid)(__prefix + 'fzzzzzzzzz' + i, true),
